...
public class User {
    ...
    @Size(min=3, message = "The First name field must be more than 3 characters")
    private String first_name;

    @NotEmpty(message = "The Last Name Field Cannot Be Empty")
    @Size(min=3, message = "The Last name field must be more than 3 characters")
    ...
    @NotNull
    @Size(min=8, message = "The password field must be more than 8 characters")
